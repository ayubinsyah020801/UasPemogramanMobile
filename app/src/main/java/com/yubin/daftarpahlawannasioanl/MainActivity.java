package com.yubin.daftarpahlawannasioanl;
...
import com.yubin.daftarpahlawannasioanl.model.Pahlawan;
...
public class MainActivity extends AppCompatActivity {
    ...
    com.yubin.daftarpahlawannasioanl.DaftarPahlawanAdapter adapter;
    ...
    private void setupListview() {
        adapter = new com.yubin.daftarpahlawannasioanl.DaftarPahlawanAdapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this,com.yubin.daftarpahlawannasioanl.FormPahlawanActivity.class);
